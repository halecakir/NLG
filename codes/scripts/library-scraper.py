...
#Use environment variable instead of system arguments
NLG_ROOT = os.environ['NLG_ROOT']
#localRepoDir = "my-lib-repo/"           # the directory to store libraries on disk with trailing path separator, e.g. "/"
localRepoDir = os.path.join(NLG_ROOT, "datasets/libraries/repo/") 
...
in_dir = os.path.join(NLG_ROOT, "datasets/libraries/library-descriptions") 
